    ...
    public static void populate(TestsConfig config) {
        ...
        if (propertyFileAnnotation != null) {
            ...
            if (propertyFileName == null) {
                throw new RuntimeException("Property file name cannot be empty. Class name : " + config.getClass().getName());
            } else {
                ...
                try {
                    ...
                    if(stream != null) {
                        ...
                        throw new RuntimeException("Unable to read property file with name '" + propertyFileName + "' - file not found");
                    }
                } catch (IOException e) {
                    throw new RuntimeException("Error while reading property file with name '" + propertyFileName + "' : " + e.getMessage(), e);
                }
            }
        } else {
